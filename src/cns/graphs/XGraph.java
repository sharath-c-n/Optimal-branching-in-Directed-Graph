...
import cns.graphs.common.ArrayIterator;
...
public class XGraph extends Graph {
    ...
    static public class XVertex extends Vertex {
        ...
        public Iterable<Edge> getNonZeroItr() {
            return () -> new NonZeroIterator(this.xAdj);
        }
        /**
        ...
        public Iterable<Edge> getNonZeroRevItr() {
            return () -> new NonZeroIterator(this.revXadj);
        }
    ...
    static class NonZeroIterator implements Iterator<Edge> {
        Iterator<XEdge> it;
        XEdge cur;
        boolean ready;

        NonZeroIterator(List<XEdge> vertex) {
            this.it = vertex.iterator();
        }
        ...
        public boolean hasNext() {
            ...
            cur = it.next();
            while ( it.hasNext() && cur.isDisabled()) {
                cur = it.next();
            }
            ready = true;
    ...
    /**
     * Creates a new component in the graph.
     * @return
     */
